...
def main() -> int:
    ...
    required = [
        ...
        ".adwf/lib/action_executors.py", ".adwf/lib/trust_boundary.py", ".adwf/lib/github_provider.py", ".adwf/lib/provider_ops_gateway.py", ".adwf/lib/github_readback.py",
        ...
        ".adwf/lib/consumer_ci.py", ".adwf/scripts/consumer_ci.py", ".adwf/tests/test_consumer_ci.py", ".adwf/tests/test_provider_ops_gateway.py",
        ".adwf/lib/external_consumer_binding.py", ".adwf/schemas/external-consumer-binding.schema.json", ".adwf/scripts/validate_external_consumer_binding.py", ".adwf/tests/test_external_consumer_binding.py",
